    ...
    <section id="top" className="relative h-screen min-h-[680px] w-full overflow-hidden bg-[#3C2F2F]">
      <motion.div style={{ y: imgY, scale: imgScale }} className="absolute inset-0">
        <Image
          ...
          alt="Paisagem de território mineiro — montanhas de Minas Gerais"
          fittingType="fill"
      ...
      >
        ...
        >
          Quais riscos sociais podem afetar sua próxima decisão?
        </motion.h1>
        ...
        >
          A Ponte Social atua na dimensão social dos negócios para identificar riscos, compreender
          contextos e relações e apoiar decisões em diferentes momentos de projetos e operações.
        </motion.p>
        ...
        >
          ...
          <span className="w-8 h-px bg-[#C87A53]" />
          <span>Gestão de relacionamentos</span>
        </motion.div>
      </motion.div>
      ...
      >
        <span className="text-[10px] tracking-[0.2em] uppercase">Role para descobrir</span>
