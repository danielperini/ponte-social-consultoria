...
export default function Segments() {
  ...
  return (
    <section id="quem-atendemos" className="py-24 lg:py-28 bg-[#A4B29B]/15">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid lg:grid-cols-12 gap-6 lg:gap-8">
          <motion.div {...fade(0.1)} className="lg:col-span-7 bg-[#073050] text-[#FFFFFF] rounded-2xl p-8 lg:p-10">
          ...
          <div className="lg:col-span-5 grid gap-6 content-start">
            {rest.map((it, i) => (
              <motion.div key={it.title} {...fade(0.15 + i * 0.05)} className="bg-[#F6F6F6] border border-[#A4B29B]/40 rounded-2xl p-6 lg:p-7">
                <h3 className="font-display text-xl text-[#073050] leading-tight">{it.title}</h3>
                <p className="mt-2 text-[#073050]/70 text-sm leading-relaxed">{it.text}</p>
              </motion.div>
            ))}
          </div>
        </div>
