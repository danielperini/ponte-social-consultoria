...
- [x] Comparados 144 arquivos locais com 144 arquivos do `main`, conteúdo idêntico por SHA; varridas referências, domínios, importações, dependências, rotas e nomes de variáveis.
